...
enum MXA_BUFFERMODE { MXA_DIRECT, MXA_ABORTING, MXA_BUFFERED };

enum MXA_CIRC_TYPE { MXA_BASE, MXA_PATH };

enum MXA_CP_APO { MXA_CP_NO_APO, MXA_C_DIS, MXA_C_ORI, MXA_C_VEL };

enum MXA_ORI_TYPE { MXA_VAR, MXA_CONSTANT, MXA_JOINT };

enum MXA_PTP_APO { MXA_NO_APO, MXA_C_PTP, MXA_C_PTP_C_DIS, MXA_C_PTP_C_ORI, MXA_C_PTP_C_VEL };
 ...
 ******************************************************************************/
inline BOOL MXA_GETIO_BYTE(_IN INT BYTEPOS, _IN BYTE *KRC4_INPUT, _OUT INT &O) {
 ...
 ******************************************************************************/
inline BOOL MXA_GETIO_DINT(_IN INT BYTEPOS, _IN BYTE *KRC4_INPUT, _OUT DINT &O) {
  DWORD DW = 0;
 ...
 ******************************************************************************/
inline BOOL MXA_GETIO_INT(_IN INT BYTEPOS, _IN BYTE *KRC4_INPUT, _OUT INT &O) {
  WORD W = 0;
 ...
 ******************************************************************************/
inline BOOL MXA_GETIO_NIBBLE(_IN INT BYTEPOS, _IN BYTE *KRC4_INPUT, _OUT INT &N1, _OUT INT &N2) {
  BYTE B = 0;
  BYTE B1 = 0;
  BYTE B2 = 0;
 ...
 ******************************************************************************/
inline BOOL MXA_GETIO_REAL(_IN INT BYTEPOS, _IN BYTE *KRC4_INPUT, _OUT REAL &O) {
  REAL *PDW;
 ...
 ******************************************************************************/
inline BOOL MXA_GETIO_SINT(_IN INT BYTEPOS, _IN BYTE *KRC4_INPUT, _OUT SINT &O) {
  BYTE B = 0;
 ...
 ******************************************************************************/
inline BOOL MXA_WRITEIO_BYTE(_IN INT BYTEPOS, _IN BYTE *KRC4_OUTPUT, _IN INT VAL) {
 ...
 ******************************************************************************/
inline BOOL MXA_WRITEIO_DINT(_IN INT BYTEPOS, _IN BYTE *KRC4_OUTPUT, _IN DINT VAL) {
 ...
 ******************************************************************************/
inline BOOL MXA_WRITEIO_DWORD(_IN INT BYTEPOS, _IN BYTE *KRC4_OUTPUT, _IN DWORD VAL) {
 ...
 ******************************************************************************/
inline BOOL MXA_WRITEIO_REAL(_IN INT BYTEPOS, _IN BYTE *KRC4_OUTPUT, _IN REAL VAL) {
  REAL *PDW;
 ...
 ******************************************************************************/
inline BOOL MXA_WRITEIO_WORD(_IN INT BYTEPOS, _IN BYTE *KRC4_OUTPUT, _IN WORD VAL) {
...
class MXA_RESETCOMMAND {
 ...
 public:
  MXA_RESETCOMMAND() : I(0), AXISGROUPIDX(0) {}
...
class MXA_GETORDERSTATE {
 ...
 public:
  void OnCycle() {
    M_ORDERSTATE = 0;
    for (I = 1; I <= 10; I += 1) {
      if ((KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.STATERETURN[I].SR_ORDERID == ORDERID) &&
          (KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.STATERETURN[I].SR_STATE > M_ORDERSTATE)) {
 ...
 public:
  void OnCycle() {
    ...
    if ((M_RE_EXECUTE && (_ERRORID == (DINT)0))) {
      M_STATE = 1;
      if ((((BUFFERMODE == 0) && (ENABLEDIRECTEXE == (BOOL)FALSE)) ||
           ((BUFFERMODE > 0) && (ENABLEQUEUEEXE == (BOOL)FALSE)))) {
        _ERRORID = (DINT)502;
      };
    ...
    if (((M_STATE == 1) && (_ERRORID == (DINT)0))) {
      if (M_RE_EXECUTE) {
        KRC_AXISGROUPREFARR[AXISGROUPIDX].LASTORDERID =
      ...
      if ((KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.ORDERIDRET == M_ORDERID)) {
        if ((KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.CMDIDRET == CMDID)) {
          if ((KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.CMDDATARETCSPLC ==
               KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.CMDDATARETCSKRC)) {
            if ((BUFFERMODE == 0)) {
              M_STATE = 15;
        ...
        if (((((KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.ORDERID == (DINT)0) &&
               (KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.COMMANDID == (DINT)0)) &&
              KRC_AXISGROUPREFARR[AXISGROUPIDX].ONLINE) &&
             (KRC_AXISGROUPREFARR[AXISGROUPIDX].INITIALIZED || IGNOREINIT))) {
...
class KRC_AUTOMATICEXTERNAL {
 ...
 public:
  void OnCycle() {
    ...
    _VALID =
        (KRC_AXISGROUPREFARR[AXISGROUPIDX].INITIALIZED && KRC_AXISGROUPREFARR[AXISGROUPIDX].ONLINE);
    if (CONF_MESS) {
    ...
    KRC_AXISGROUPREFARR[AXISGROUPIDX].AUTEXTCONTROL.MOVE_ENABLE =
        ((((MOVE_ENABLE && ((ENABLE_T1 && _T1) || !(_T1))) && ((ENABLE_T2 && _T2) || !(_T2))) &&
          ((ENABLE_AUT && _AUT) || !(_AUT))) &&
         ((ENABLE_EXT && _EXT) || !(_EXT)));
  }
};
...
class KRC_READMXAERROR {
 ...
 public:
  KRC_READMXAERROR()
      : AXISGROUPIDX(0), ERROR(_ERROR), ERRORID(_ERRORID), _ERROR((BOOL)FALSE), _ERRORID(0) {}
...
class KRC_AUTOSTART {
 ...
 public:
  void OnCycle() {
    ...
    _RESETVALID = (((((KRC_AXISGROUPREFARR[AXISGROUPIDX].AUTEXTSTATE.EXT &&
                       KRC_AXISGROUPREFARR[AXISGROUPIDX].INITIALIZED) &&
                      KRC_AXISGROUPREFARR[AXISGROUPIDX].ONLINE) &&
                     !(_DISPACTIVE)) &&
                    KRC_AXISGROUPREFARR[AXISGROUPIDX].AUTEXTSTATE.ALARM_STOP) &&
                   KRC_AXISGROUPREFARR[AXISGROUPIDX].AUTEXTSTATE.USER_SAFE);
    if (!(EXECUTERESET)) {
      M_STATE = 0;
      _ERRORID = (DINT)0;
    };
  ...
  void OnCycle() {
    ...
    if (EXECUTECMD) {
      ...
      if ((ABSOLUTEVELOCITY > 0.0)) {
        ...
        M_VELOCITY = (DINT)REAL_TO_DINT(
            ((ABSOLUTEVELOCITY * -100000.0) / KRC_AXISGROUPREFARR[AXISGROUPIDX].DEF_VEL_CP));
      };
      ...
      if ((ABSOLUTEACCELERATION > 0.0)) {
        ...
        M_ACCELERATION =
            (DINT)(ABSOLUTEACCELERATION * -100000.0 / KRC_AXISGROUPREFARR[AXISGROUPIDX].DEF_ACC_CP);
      };
    };
    ...
    if (MXA_EXECUTECOMMAND_1.WRITECMDPAR) {
      ...
      if (((((MOVETYPE == 0) || (MOVETYPE == 10)) || (MOVETYPE == 9)) || (MOVETYPE == 19))) {
        ...
        KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARINT[5] =
            INT_TO_DINT(COORDINATESYSTEM.IPO_MODE);
      };
...
class KRC_ERROR {
 ...
 public:
  void OnCycle() {
    ...
    _ERROR = (_ERRORID != (DINT)0);
    ENABLETONSUBMIT = ((M_HEARTBEATLAST == KRC_AXISGROUPREFARR[AXISGROUPIDX].KRCSTATE.HEARTBEAT) &&
                       (KRC_AXISGROUPREFARR[AXISGROUPIDX].KRCSTATE.HEARTBEAT >= 0));
    ENABLETONPCOS =
        ((M_HEARTBEATLASTPCOS == KRC_AXISGROUPREFARR[AXISGROUPIDX].KRCSTATE.HEARTBEATPCOS) &&
         (KRC_AXISGROUPREFARR[AXISGROUPIDX].KRCSTATE.HEARTBEATPCOS >= 0));
    // Call FB TON_HBSub
    ...
    _NOMOVEENABLE = (!(KRC_AXISGROUPREFARR[AXISGROUPIDX].AUTEXTCONTROL.MOVE_ENABLE) ||
                     KRC_AXISGROUPREFARR[AXISGROUPIDX].AUTEXTCONTROL.MOVE_DISABLE);
 ...
 public:
  void OnCycle() {
    ...
    if ((MXA_EXECUTECOMMAND_0.WRITECMDPAR && (NSTATE == 0))) {
      ...
      KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARREAL[11] = AXIS_VALUES.E5;
      KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARREAL[12] = AXIS_VALUES.E6;
      KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARINT[2] =
          KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.ORDERID;
      KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARINT[3] = INT_TO_DINT(COORDINATESYSTEM.TOOL);
      KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARINT[4] = INT_TO_DINT(COORDINATESYSTEM.BASE);
      KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARINT[5] =
          INT_TO_DINT(COORDINATESYSTEM.IPO_MODE);
...
class KRC_INITIALIZE {
 ...
 public:
  void OnCycle() {
    ...
    if ((((KRC_AXISGROUPREFARR[AXISGROUPIDX].INITIALIZED == (BOOL)FALSE) &&
          (KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.COMMANDID > (DINT)0)) &&
         (KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.COMMANDID != (DINT)31))) {
    ...
    if (MXA_EXECUTECOMMAND_1.READCMDDATARET) {
      ...
      KRC_AXISGROUPREFARR[AXISGROUPIDX].DEF_VEL_CP =
          KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.CMDDATARETURN[5];
      KRC_AXISGROUPREFARR[AXISGROUPIDX].DEF_ACC_CP =
          KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.CMDDATARETURN[6];
...
class KRC_JOG {
 ...
 public:
  void OnCycle() {
    ...
    if (((((((((((((A1_X_P && A1_X_M) || (A2_Y_P && A2_Y_M)) || (A3_Z_P && A3_Z_M)) ||
                 (A4_A_P && A4_A_M)) ||
                (A5_B_P && A5_B_M)) ||
               (A6_C_P && A6_C_M)) ||
              (E1_P && E1_M)) ||
    ...
    M_CMDINPUTACTIVE =
        (((((((((((((((((((((((A1_X_P || A1_X_M) || A2_Y_P) || A2_Y_M) || A3_Z_P) || A3_Z_M) ||
                          A4_A_P) ||
                         A4_A_M) ||
                        A5_B_P) ||
                       A5_B_M) ||
...
class KRC_JOGADVANCED {
 ...
 public:
  void OnCycle() {
    ...
    if (((((((((((((((((((B_A1_JA_P && B_A1_JA_M) || (B_A2_JA_P && B_A2_JA_M)) ||
                        (B_A3_JA_P && B_A3_JA_M)) ||
                       (B_A4_JA_P && B_A4_JA_M)) ||
                      (B_A5_JA_P && B_A5_JA_M)) ||
                     (B_A6_JA_P && B_A6_JA_M)) ||
...
class KRC_READACTUALAXISPOSITION {
 ...
 public:
  void OnCycle() {
    ...
    _VALID = ((KRC_AXISGROUPREFARR[AXISGROUPIDX].KRCSTATE.AXISACTVALID &&
               KRC_AXISGROUPREFARR[AXISGROUPIDX].INITIALIZED) &&
              KRC_AXISGROUPREFARR[AXISGROUPIDX].ONLINE);
  }
};
...
class KRC_READACTUALPOSITION {
 ...
 public:
  void OnCycle() {
    ...
    _VALID = ((KRC_AXISGROUPREFARR[AXISGROUPIDX].KRCSTATE.POSACTVALID &&
               KRC_AXISGROUPREFARR[AXISGROUPIDX].INITIALIZED) &&
              KRC_AXISGROUPREFARR[AXISGROUPIDX].ONLINE);
  }
};
...
class KRC_READACTUALVELOCITY {
 ...
 public:
  KRC_READACTUALVELOCITY()
      : AXISGROUPIDX(0), VALID(_VALID), VALUE(_VALUE), _VALID((BOOL)FALSE), _VALUE(0) {}
 ...
 public:
  void OnCycle() {
    ...
    ENABLETONPCOS =
        ((M_HEARTBEATLASTPCOS == KRC_AXISGROUPREFARR[AXISGROUPIDX].KRCSTATE.HEARTBEATPCOS) &&
         (KRC_AXISGROUPREFARR[AXISGROUPIDX].KRCSTATE.HEARTBEATPCOS > 0));
    if ((((M_HEARTBEATLAST != KRC_AXISGROUPREFARR[AXISGROUPIDX].KRCSTATE.HEARTBEAT) &&
          (KRC_AXISGROUPREFARR[AXISGROUPIDX].KRCSTATE.HEARTBEAT > 0)) &&
         ((M_HEARTBEATLASTPCOS != KRC_AXISGROUPREFARR[AXISGROUPIDX].KRCSTATE.HEARTBEATPCOS) &&
          (KRC_AXISGROUPREFARR[AXISGROUPIDX].KRCSTATE.HEARTBEATPCOS > 0)))) {
    ...
    // Call FB TON_2
    TON_2.IN = (((KRC_AXISGROUPREFARR[AXISGROUPIDX].ONLINE &&
                  (KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.COMMANDID > (DINT)0)) &&
                 (KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.ORDERID == M_LASTORDERID)) &&
                (KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.ORDERID ==
                 KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.ORDERIDRET));
    ...
    M_CONNECTIONOK =
        (KRC_AXISGROUPREFARR[AXISGROUPIDX].ONLINE && KRC_AXISGROUPREFARR[AXISGROUPIDX].INITIALIZED);
    ...
    if ((KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.ORDERID == M_ORDERIDRET)) {
      ...
      NCHECKSUM =
          (NCHECKSUM ^ DINT_TO_DWORD(KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.ORDERIDRET));
 ...
 public:
  void OnCycle() {
    ...
    if (((INTERRUPT >= 1) && (INTERRUPT <= 8))) {
      ...
      _VALID = (KRC_AXISGROUPREFARR[AXISGROUPIDX].INITIALIZED &&
                KRC_AXISGROUPREFARR[AXISGROUPIDX].ONLINE);
    } else {
      _VALUE = 0;
      _VALID = (BOOL)FALSE;
 ...
 public:
  void OnCycle() {
    ...
    if (MXA_EXECUTECOMMAND_1.WRITECMDPAR) {
      ...
      KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARINT[5] =
          INT_TO_DINT(COORDSYSTODISPLAY.IPO_MODE);
    }
 ...
 public:
  void OnCycle() {
    ...
    if (R_TRIG_1.Q) {
      ...
      POSITIONARRAY[INDEX].COORDSYS_1.IPO_MODE =
          KRC_AXISGROUPREFARR[AXISGROUPIDX].KRCSTATE.IPOMODEACT;
...
class KRC_WRITEAXISGROUP {
 ...
 public:
  void OnCycle() {
    ...
    AE_MOVE_ENABLE_VAL = ((((((KRC_AXISGROUPREFARR[AXISGROUPIDX].AUTEXTCONTROL.MOVE_ENABLE &&
                               !(KRC_AXISGROUPREFARR[AXISGROUPIDX].AUTEXTCONTROL.MOVE_DISABLE)) &&
                              KRC_AXISGROUPREFARR[AXISGROUPIDX].ONLINE) &&
                             (KRC_AXISGROUPREFARR[AXISGROUPIDX].KRCSTATE.ERRORID == (DINT)0)) &&
                            (KRC_AXISGROUPREFARR[AXISGROUPIDX].KRCSTATE.ERRORIDSUB == (DINT)0)) &&
                           (KRC_AXISGROUPREFARR[AXISGROUPIDX].INTERRORID == (DINT)0)) &&
                          (KRC_AXISGROUPREFARR[AXISGROUPIDX].INTFBERRORID == (DINT)0));
    ...
    SR_ORDER1_STATE_VAL =
        INT_TO_BYTE(KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.STATERETURN[1].SR_STATE);
    SR_ORDER2_STATE_VAL =
        INT_TO_BYTE(KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.STATERETURN[2].SR_STATE);
    SR_ORDER3_STATE_VAL =
        INT_TO_BYTE(KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.STATERETURN[3].SR_STATE);
    SR_ORDER4_STATE_VAL =
        INT_TO_BYTE(KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.STATERETURN[4].SR_STATE);
    SR_ORDER5_STATE_VAL =
        INT_TO_BYTE(KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.STATERETURN[5].SR_STATE);
    SR_ORDER6_STATE_VAL =
        INT_TO_BYTE(KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.STATERETURN[6].SR_STATE);
    SR_ORDER7_STATE_VAL =
        INT_TO_BYTE(KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.STATERETURN[7].SR_STATE);
    SR_ORDER8_STATE_VAL =
        INT_TO_BYTE(KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.STATERETURN[8].SR_STATE);
    SR_ORDER9_STATE_VAL =
        INT_TO_BYTE(KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.STATERETURN[9].SR_STATE);
    SR_ORDER10_STATE_VAL =
        INT_TO_BYTE(KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.STATERETURN[10].SR_STATE);
    ...
    if ((LASTORDERID != KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.ORDERID)) {
      ...
      if ((KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.COMMANDID > 0)) {
        ...
        NCHECKSUM =
            (NCHECKSUM ^ DINT_TO_DWORD(KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.BUFFERMODE));
        for (I = 1; I <= 45; I += 1) {
          if ((KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[I] == (BOOL)TRUE)) {
            NCHECKSUM = (NCHECKSUM ^ (DWORD)1);
          };
          NCHECKSUM =
              (NCHECKSUM ^ DINT_TO_DWORD(KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARINT[I]));
    ...
    if ((KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.COMMANDID > 0)) {
      if ((KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.COMMANDSIZE > 1)) {
        if (((KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.TRANSMISSIONNORET == LASTTGNUMBER) &&
             (KRC_AXISGROUPREFARR[AXISGROUPIDX].CMDSTATE.TRANSMISSIONNORET ==
              TRANSMISSIONNO1_VAL))) {
          LASTTGNUMBER = (LASTTGNUMBER + 1);
          if (((LASTTGNUMBER <= 0) || (LASTTGNUMBER >= 255))) {
            LASTTGNUMBER = 1;
          ...
          if (((LASTTGTYPE == 3) || (LASTTGTYPE == 5))) {
            ...
            BUFFERMODE_VAL = DINT_TO_INT(KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.BUFFERMODE);
            ChBit(BOOLVALUES1, 0,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[16]);
            ChBit(BOOLVALUES1, 1,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[17]);
            ChBit(BOOLVALUES1, 2,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[18]);
            ChBit(BOOLVALUES1, 3,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[19]);
            ChBit(BOOLVALUES1, 4,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[20]);
            ChBit(BOOLVALUES1, 5,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[21]);
            ChBit(BOOLVALUES1, 6,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[22]);
            ChBit(BOOLVALUES1, 7,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[23]);
            ChBit(BOOLVALUES1, 8,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[24]);
            ChBit(BOOLVALUES1, 9,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[25]);
            ChBit(BOOLVALUES1, 10,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[26]);
            ChBit(BOOLVALUES1, 11,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[27]);
            ChBit(BOOLVALUES1, 12,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[28]);
            ChBit(BOOLVALUES1, 13,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[29]);
            ChBit(BOOLVALUES1, 14,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[30]);
            ...
            BUFFERMODE_VAL = DINT_TO_INT(KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.BUFFERMODE);
            ChBit(BOOLVALUES1, 0,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[31]);
            ChBit(BOOLVALUES1, 1,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[32]);
            ChBit(BOOLVALUES1, 2,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[33]);
            ChBit(BOOLVALUES1, 3,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[34]);
            ChBit(BOOLVALUES1, 4,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[35]);
            ChBit(BOOLVALUES1, 5,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[36]);
            ChBit(BOOLVALUES1, 6,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[37]);
            ChBit(BOOLVALUES1, 7,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[38]);
            ChBit(BOOLVALUES1, 8,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[39]);
            ChBit(BOOLVALUES1, 9,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[40]);
            ChBit(BOOLVALUES1, 10,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[41]);
            ChBit(BOOLVALUES1, 11,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[42]);
            ChBit(BOOLVALUES1, 12,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[43]);
            ChBit(BOOLVALUES1, 13,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[44]);
            ChBit(BOOLVALUES1, 14,
                  /* := */ KRC_AXISGROUPREFARR[AXISGROUPIDX].COMMAND.CMDPARBOOL[45]);
 ...
 public:
  void OnCycle() {
    ...
    if ((M_RE_EXECUTE && (M_INTERRORID == (DINT)0))) {
      M_STATE = 1;
      if ((((QUEUEMODE == 0) && (ENABLEDIRECTEXE == (BOOL)FALSE)) ||
           ((QUEUEMODE > 0) && (ENABLEQUEUEEXE == (BOOL)FALSE)))) {
  ...
  void OnCycle() {
    ...
    if (EXECUTE) {
      ...
      if ((ABSOLUTEACCELERATION > 0.0)) {
        ...
        M_ACCELERATION = (DINT)REAL_TO_DINT(ABSOLUTEACCELERATION * -100000.0 /
                                            KRC_AXISGROUPREFARR[AXISGROUPIDX].DEF_ACC_CP);
      };
    };
    if (((((MOVETYPE == 7) || (MOVETYPE == 8)) || (MOVETYPE == 17)) || (MOVETYPE == 18))) {
...
class MXA_VALUESTOCOORDSYS {
 ...
 public:
  MXA_VALUESTOCOORDSYS() : TOOL(0), BASE(0), IPO_MODE(0), COORDSYS_1(_COORDSYS_1), _COORDSYS_1() {}
...
class MXA_VALUESTOFRAME {
 ...
 public:
  MXA_VALUESTOFRAME() : X(0), Y(0), Z(0), A(0), B(0), C(0), FRAME_1(_FRAME_1), _FRAME_1() {}
