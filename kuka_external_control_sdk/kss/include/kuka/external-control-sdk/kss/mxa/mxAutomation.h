...
public:
   KRC_READKRCERROR()
       : AXISGROUPIDX(0), EXECUTECMD((PLCIEC::BOOL)FALSE), OFFSET(0), DONE(_DONE), ERROR(_ERROR), ERRORID(_ERRORID), STOPMESS(_STOPMESS), MESSAGECOUNT(_MESSAGECOUNT), MESSAGE1(_MESSAGE1), MESSAGE2(_MESSAGE2), MESSAGE3(_MESSAGE3), MESSAGE4(_MESSAGE4), MESSAGE5(_MESSAGE5), MESSAGE6(_MESSAGE6), MESSAGE7(_MESSAGE7), MESSAGE8(_MESSAGE8), MESSAGE9(_MESSAGE9), MESSAGE10(_MESSAGE10), ORDERID(_ORDERID), _DONE((PLCIEC::BOOL)FALSE), _ERROR((PLCIEC::BOOL)FALSE), _ERRORID(0), _STOPMESS((PLCIEC::BOOL)FALSE), _MESSAGECOUNT(0), _MESSAGE1(0), _MESSAGE2(0), _MESSAGE3(0), _MESSAGE4(0), _MESSAGE5(0), _MESSAGE6(0), _MESSAGE7(0), _MESSAGE8(0), _MESSAGE9(0), _MESSAGE10(0), _ORDERID(0), MXA_EXECUTECOMMAND_1()
   {
   }
...
public:
   void OnCycle()
   {
      ...
      MXA_EXECUTECOMMAND_1.CMDID = (PLCIEC::DINT)24;
      MXA_EXECUTECOMMAND_1.BUFFERMODE = 0;
      MXA_EXECUTECOMMAND_1.COMMANDSIZE = 1;
      MXA_EXECUTECOMMAND_1.ENABLEDIRECTEXE = (PLCIEC::BOOL)TRUE;
      MXA_EXECUTECOMMAND_1.ENABLEQUEUEEXE = (PLCIEC::BOOL)FALSE;
      MXA_EXECUTECOMMAND_1.IGNOREINIT = (PLCIEC::BOOL)FALSE;
      MXA_EXECUTECOMMAND_1.OnCycle();
