...
public:
  ControlSignal(std::size_t dof,
                std::vector<GPIOConfiguration> gpio_state_config_list,
                std::vector<GPIOConfiguration> gpio_command_config_list)
      : BaseControlSignal(dof), initial_positions_(dof, gpio_state_config_list) {
